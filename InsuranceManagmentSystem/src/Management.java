...
public class Management {
    ...
    public void addUser(String userType,String name,String surname,String email,String password,String occupation,
                        int age,String companyName){
        User user= new User(name,surname,email,password,occupation,age);
    ...
    public Account login(String userEmail,String password){
        Account account= accountManager.login(userEmail,password);
        if(account!=null){
    ...
    public void listAccounts() {
        ...
        for (Account a : accountList) {
            System.out.format(format, a.getUser().getName(), a.getUser().getSurname(), a.getUser().getEmail(),
                    a.getUser().getPassword(), a.getUser().getOccupation(), a.getUser().getAge(),
                    a.getUser().getLastInput(), a.getClass().getSimpleName());
        }
    }
